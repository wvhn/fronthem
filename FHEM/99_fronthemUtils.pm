...
###############################################################################
#
# connect fhem device with JSON data
#
###############################################################################
...
=begin html
  ...
  <ul>
    ...
    <ul>
      ...
      <li><b>JSON</b><br>send / receive readings as JSON objects</li><br/>
...
=begin html_DE
  ...
  <ul>
    ...
    <ul>
      ...
      <li><b>JSON</b><br>sendet / empf&auml;ngt Readings als JSON-Objekte</li><br/>
